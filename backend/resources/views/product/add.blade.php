            ...
            <div class="row">
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="product_name" class="form-control" id="name" aria-describedby="name">
                    </div>
                </div>
                <div class="col-6">
                    <div class="mb-3">
                        <label for="price" class="form-label">Product Price</label>
                        <input type="number" min="0" name="price" class="form-control" id="price" aria-describedby="name">
                    </div>
                </div>
