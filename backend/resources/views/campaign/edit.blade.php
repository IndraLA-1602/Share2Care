    ...
    <div class="card-body">
        <form action="{{route('campaign.update', $campaign->id)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="campaign_name" value="{{$campaign->name}}" class="form-control" id="name" aria-describedby="name">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea name="address" class="form-control" id="address">{{$campaign->alamat}}</textarea>
            </div>

            <div class="mb-3">
                <label for="judul" class="form-label">Description</label>
                <textarea type="text" name="desc" class="form-control" id="desc"
                    aria-describedby="desc">{{$campaign->desc}}</textarea>
            </div>
            <div class="mb-3">
