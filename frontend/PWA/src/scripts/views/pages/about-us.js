      ...
      <header>
        ...
        <header>
          <section class="misi">
            <h2>Misi Kami</h2>
            <p>
              Dengan cara ini, diharapkan nantinya anda dapat membantu
              orang-orang yang membutuhkan dan berpartisipasi dalam kegiatan
              sosial tanpa harus mengeluarkan biaya yang besar, mencari ataupun
              bertemu secara langsung dengan penerima bantuan. Website ini
              nantinya dapat memudahkan Anda untuk berdonasi dengan memilih
              berbagai barang yang tersedia secara online cepat, mudah, dan
              tanpa tenaga.
            </p>
          </section>
        </header>
